<!-- addclashses -->
<!-- addcslashes() adalah fungsi PHP yang digunakan untuk menambahkan karakter escape 
(\) sebelum karakter tertentu dalam sebuah string. -->
<?php 
...
<!-- bin2hex() -->
<!-- fungsi PHP bin2hex() untuk mengonversi string "Hello World!" menjadi format 
heksadesimal (hex). -->
<?php
...
<!-- chr() -->
<!-- fungsi chr() untuk mengonversi nilai desimal, oktal, dan heksadesimal menjadi 
karakter.  -->
<?php
echo "<hr>";
...
<!-- chunk_split() -->
<!-- fungsi chunk_split() untuk membagi string "Hello world!" menjadi bagian-bagian 
yang lebih kecil, dan setiap bagian dipisahkan oleh tanda "." (titik). -->
<?php
$str = "Hello world!";
...
<!-- fprintf() -->
<!-- fungsi fprintf() untuk menulis teks ke dalam file "test.txt" dengan format tertentu. 
Fungsi ini mirip dengan printf(), tetapi data yang diformat akan ditulis ke dalam file yang ditentukan. -->
<?php
$number = 9;
$str = "Beijing";
...
<!-- count_chars() -->
<!-- fungsi count_chars() untuk menghitung karakter yang ada dalam string "Hello World!" 
dan mengembalikan daftar karakter yang ditemukan beserta jumlah kemunculannya dalam string tersebut. -->
<?php
$str = "Hello World!";
